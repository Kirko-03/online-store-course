    ...
    return <Container className='d-flex justify-content-center align-items-center'
        ...
        <Card style={{width: 600}} className='p-5'>
            ...
            <Form className="d-flex flex-column">
                ...
                <Row className="mt-3 ">
                    {isLogin ? <div>Есть аккаунт?<NavLink to={REGISTRATION_ROUTE}>Войдите!</NavLink></div> :
                        <div>Нет аккаунта?<NavLink to={LOGIN_ROUTE}>Зарегистрируйся!</NavLink></div>}
                    <Button variant={"outline-success"}
                            className="align-self-end mt-3 ">{isLogin ? 'Зарегистрироваться' : 'Войти'}</Button>
                </Row>
            </Form>
        </Card>
    </Container>
